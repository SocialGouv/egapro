...
| **2030** | **7 indicateurs** | Les 12 cas :<br>[2030-149-CAS01](#cas-01) sans CSE, aucun écart — fin de démarche<br>[2030-149-CAS02](#cas-02) avec CSE, aucun écart — avis CSE « exactitude »<br>[2030-149-CAS03](#cas-03) sans CSE — justification des écarts<br>[2030-149-CAS04](#cas-04) avec CSE — justification + avis CSE<br>[2030-149-CAS05](#cas-05) sans CSE — éval. conjointe + rapport<br>[2030-149-CAS06](#cas-06) avec CSE — éval. conjointe + rapport + avis CSE<br>[2030-149-CAS07](#cas-07) sans CSE — actions correctives, 2ᵉ décl. sans écart<br>[2030-149-CAS08](#cas-08) avec CSE — actions correctives, 2ᵉ décl. sans écart + avis CSE sur les 2 décl.<br>[2030-149-CAS09](#cas-09) sans CSE — 2ᵉ décl. avec écart → justification<br>[2030-149-CAS10](#cas-10) avec CSE — 2ᵉ décl. avec écart → justification + avis CSE sur les 2 décl.<br>[2030-149-CAS11](#cas-11) sans CSE — 2ᵉ décl. avec écart → éval. conjointe + rapport<br>[2030-149-CAS12](#cas-12) avec CSE — 2ᵉ décl. avec écart → éval. conjointe + rapport + avis CSE sur les 2 décl. |
...
| **2033** | **7 indicateurs** | Les 12 cas :<br>[2033-149-CAS01](#cas-01) sans CSE, aucun écart — fin de démarche<br>[2033-149-CAS02](#cas-02) avec CSE, aucun écart — avis CSE « exactitude »<br>[2033-149-CAS03](#cas-03) sans CSE — justification des écarts<br>[2033-149-CAS04](#cas-04) avec CSE — justification + avis CSE<br>[2033-149-CAS05](#cas-05) sans CSE — éval. conjointe + rapport<br>[2033-149-CAS06](#cas-06) avec CSE — éval. conjointe + rapport + avis CSE<br>[2033-149-CAS07](#cas-07) sans CSE — actions correctives, 2ᵉ décl. sans écart<br>[2033-149-CAS08](#cas-08) avec CSE — actions correctives, 2ᵉ décl. sans écart + avis CSE sur les 2 décl.<br>[2033-149-CAS09](#cas-09) sans CSE — 2ᵉ décl. avec écart → justification<br>[2033-149-CAS10](#cas-10) avec CSE — 2ᵉ décl. avec écart → justification + avis CSE sur les 2 décl.<br>[2033-149-CAS11](#cas-11) sans CSE — 2ᵉ décl. avec écart → éval. conjointe + rapport<br>[2033-149-CAS12](#cas-12) avec CSE — 2ᵉ décl. avec écart → éval. conjointe + rapport + avis CSE sur les 2 décl. |
...
| Année | Déclaration | Cas à dérouler |
|---|---|---|
| **2027** | **7 indicateurs** | Les 12 cas :<br>[2027-249-CAS01](#cas-01) sans CSE, aucun écart — fin de démarche<br>[2027-249-CAS02](#cas-02) avec CSE, aucun écart — avis CSE « exactitude »<br>[2027-249-CAS03](#cas-03) sans CSE — justification des écarts<br>[2027-249-CAS04](#cas-04) avec CSE — justification + avis CSE<br>[2027-249-CAS05](#cas-05) sans CSE — éval. conjointe + rapport<br>[2027-249-CAS06](#cas-06) avec CSE — éval. conjointe + rapport + avis CSE<br>[2027-249-CAS07](#cas-07) sans CSE — actions correctives, 2ᵉ décl. sans écart<br>[2027-249-CAS08](#cas-08) avec CSE — actions correctives, 2ᵉ décl. sans écart + avis CSE sur les 2 décl.<br>[2027-249-CAS09](#cas-09) sans CSE — 2ᵉ décl. avec écart → justification<br>[2027-249-CAS10](#cas-10) avec CSE — 2ᵉ décl. avec écart → justification + avis CSE sur les 2 décl.<br>[2027-249-CAS11](#cas-11) sans CSE — 2ᵉ décl. avec écart → éval. conjointe + rapport<br>[2027-249-CAS12](#cas-12) avec CSE — 2ᵉ décl. avec écart → éval. conjointe + rapport + avis CSE sur les 2 décl. |
...
| **2030** | **7 indicateurs** | Les 12 cas :<br>[2030-249-CAS01](#cas-01) sans CSE, aucun écart — fin de démarche<br>[2030-249-CAS02](#cas-02) avec CSE, aucun écart — avis CSE « exactitude »<br>[2030-249-CAS03](#cas-03) sans CSE — justification des écarts<br>[2030-249-CAS04](#cas-04) avec CSE — justification + avis CSE<br>[2030-249-CAS05](#cas-05) sans CSE — éval. conjointe + rapport<br>[2030-249-CAS06](#cas-06) avec CSE — éval. conjointe + rapport + avis CSE<br>[2030-249-CAS07](#cas-07) sans CSE — actions correctives, 2ᵉ décl. sans écart<br>[2030-249-CAS08](#cas-08) avec CSE — actions correctives, 2ᵉ décl. sans écart + avis CSE sur les 2 décl.<br>[2030-249-CAS09](#cas-09) sans CSE — 2ᵉ décl. avec écart → justification<br>[2030-249-CAS10](#cas-10) avec CSE — 2ᵉ décl. avec écart → justification + avis CSE sur les 2 décl.<br>[2030-249-CAS11](#cas-11) sans CSE — 2ᵉ décl. avec écart → éval. conjointe + rapport<br>[2030-249-CAS12](#cas-12) avec CSE — 2ᵉ décl. avec écart → éval. conjointe + rapport + avis CSE sur les 2 décl. |
...
| **2033** | **7 indicateurs** | Les 12 cas :<br>[2033-249-CAS01](#cas-01) sans CSE, aucun écart — fin de démarche<br>[2033-249-CAS02](#cas-02) avec CSE, aucun écart — avis CSE « exactitude »<br>[2033-249-CAS03](#cas-03) sans CSE — justification des écarts<br>[2033-249-CAS04](#cas-04) avec CSE — justification + avis CSE<br>[2033-249-CAS05](#cas-05) sans CSE — éval. conjointe + rapport<br>[2033-249-CAS06](#cas-06) avec CSE — éval. conjointe + rapport + avis CSE<br>[2033-249-CAS07](#cas-07) sans CSE — actions correctives, 2ᵉ décl. sans écart<br>[2033-249-CAS08](#cas-08) avec CSE — actions correctives, 2ᵉ décl. sans écart + avis CSE sur les 2 décl.<br>[2033-249-CAS09](#cas-09) sans CSE — 2ᵉ décl. avec écart → justification<br>[2033-249-CAS10](#cas-10) avec CSE — 2ᵉ décl. avec écart → justification + avis CSE sur les 2 décl.<br>[2033-249-CAS11](#cas-11) sans CSE — 2ᵉ décl. avec écart → éval. conjointe + rapport<br>[2033-249-CAS12](#cas-12) avec CSE — 2ᵉ décl. avec écart → éval. conjointe + rapport + avis CSE sur les 2 décl. |
...
| Année | Déclaration | Cas à dérouler |
|---|---|---|
| **2027** | **7 indicateurs** | Les 12 cas :<br>[2027-250P-CAS01](#cas-01) sans CSE, aucun écart — fin de démarche<br>[2027-250P-CAS02](#cas-02) avec CSE, aucun écart — avis CSE « exactitude »<br>[2027-250P-CAS03](#cas-03) sans CSE — justification des écarts<br>[2027-250P-CAS04](#cas-04) avec CSE — justification + avis CSE<br>[2027-250P-CAS05](#cas-05) sans CSE — éval. conjointe + rapport<br>[2027-250P-CAS06](#cas-06) avec CSE — éval. conjointe + rapport + avis CSE<br>[2027-250P-CAS07](#cas-07) sans CSE — actions correctives, 2ᵉ décl. sans écart<br>[2027-250P-CAS08](#cas-08) avec CSE — actions correctives, 2ᵉ décl. sans écart + avis CSE sur les 2 décl.<br>[2027-250P-CAS09](#cas-09) sans CSE — 2ᵉ décl. avec écart → justification<br>[2027-250P-CAS10](#cas-10) avec CSE — 2ᵉ décl. avec écart → justification + avis CSE sur les 2 décl.<br>[2027-250P-CAS11](#cas-11) sans CSE — 2ᵉ décl. avec écart → éval. conjointe + rapport<br>[2027-250P-CAS12](#cas-12) avec CSE — 2ᵉ décl. avec écart → éval. conjointe + rapport + avis CSE sur les 2 décl. |
| **2028** | **7 indicateurs** | Les 12 cas :<br>[2028-250P-CAS01](#cas-01) sans CSE, aucun écart — fin de démarche<br>[2028-250P-CAS02](#cas-02) avec CSE, aucun écart — avis CSE « exactitude »<br>[2028-250P-CAS03](#cas-03) sans CSE — justification des écarts<br>[2028-250P-CAS04](#cas-04) avec CSE — justification + avis CSE<br>[2028-250P-CAS05](#cas-05) sans CSE — éval. conjointe + rapport<br>[2028-250P-CAS06](#cas-06) avec CSE — éval. conjointe + rapport + avis CSE<br>[2028-250P-CAS07](#cas-07) sans CSE — actions correctives, 2ᵉ décl. sans écart<br>[2028-250P-CAS08](#cas-08) avec CSE — actions correctives, 2ᵉ décl. sans écart + avis CSE sur les 2 décl.<br>[2028-250P-CAS09](#cas-09) sans CSE — 2ᵉ décl. avec écart → justification<br>[2028-250P-CAS10](#cas-10) avec CSE — 2ᵉ décl. avec écart → justification + avis CSE sur les 2 décl.<br>[2028-250P-CAS11](#cas-11) sans CSE — 2ᵉ décl. avec écart → éval. conjointe + rapport<br>[2028-250P-CAS12](#cas-12) avec CSE — 2ᵉ décl. avec écart → éval. conjointe + rapport + avis CSE sur les 2 décl. |
| **2029** | **7 indicateurs** | Les 12 cas :<br>[2029-250P-CAS01](#cas-01) sans CSE, aucun écart — fin de démarche<br>[2029-250P-CAS02](#cas-02) avec CSE, aucun écart — avis CSE « exactitude »<br>[2029-250P-CAS03](#cas-03) sans CSE — justification des écarts<br>[2029-250P-CAS04](#cas-04) avec CSE — justification + avis CSE<br>[2029-250P-CAS05](#cas-05) sans CSE — éval. conjointe + rapport<br>[2029-250P-CAS06](#cas-06) avec CSE — éval. conjointe + rapport + avis CSE<br>[2029-250P-CAS07](#cas-07) sans CSE — actions correctives, 2ᵉ décl. sans écart<br>[2029-250P-CAS08](#cas-08) avec CSE — actions correctives, 2ᵉ décl. sans écart + avis CSE sur les 2 décl.<br>[2029-250P-CAS09](#cas-09) sans CSE — 2ᵉ décl. avec écart → justification<br>[2029-250P-CAS10](#cas-10) avec CSE — 2ᵉ décl. avec écart → justification + avis CSE sur les 2 décl.<br>[2029-250P-CAS11](#cas-11) sans CSE — 2ᵉ décl. avec écart → éval. conjointe + rapport<br>[2029-250P-CAS12](#cas-12) avec CSE — 2ᵉ décl. avec écart → éval. conjointe + rapport + avis CSE sur les 2 décl. |
| **2030** | **7 indicateurs** | Les 12 cas :<br>[2030-250P-CAS01](#cas-01) sans CSE, aucun écart — fin de démarche<br>[2030-250P-CAS02](#cas-02) avec CSE, aucun écart — avis CSE « exactitude »<br>[2030-250P-CAS03](#cas-03) sans CSE — justification des écarts<br>[2030-250P-CAS04](#cas-04) avec CSE — justification + avis CSE<br>[2030-250P-CAS05](#cas-05) sans CSE — éval. conjointe + rapport<br>[2030-250P-CAS06](#cas-06) avec CSE — éval. conjointe + rapport + avis CSE<br>[2030-250P-CAS07](#cas-07) sans CSE — actions correctives, 2ᵉ décl. sans écart<br>[2030-250P-CAS08](#cas-08) avec CSE — actions correctives, 2ᵉ décl. sans écart + avis CSE sur les 2 décl.<br>[2030-250P-CAS09](#cas-09) sans CSE — 2ᵉ décl. avec écart → justification<br>[2030-250P-CAS10](#cas-10) avec CSE — 2ᵉ décl. avec écart → justification + avis CSE sur les 2 décl.<br>[2030-250P-CAS11](#cas-11) sans CSE — 2ᵉ décl. avec écart → éval. conjointe + rapport<br>[2030-250P-CAS12](#cas-12) avec CSE — 2ᵉ décl. avec écart → éval. conjointe + rapport + avis CSE sur les 2 décl. |
| **2031** | **7 indicateurs** | Les 12 cas :<br>[2031-250P-CAS01](#cas-01) sans CSE, aucun écart — fin de démarche<br>[2031-250P-CAS02](#cas-02) avec CSE, aucun écart — avis CSE « exactitude »<br>[2031-250P-CAS03](#cas-03) sans CSE — justification des écarts<br>[2031-250P-CAS04](#cas-04) avec CSE — justification + avis CSE<br>[2031-250P-CAS05](#cas-05) sans CSE — éval. conjointe + rapport<br>[2031-250P-CAS06](#cas-06) avec CSE — éval. conjointe + rapport + avis CSE<br>[2031-250P-CAS07](#cas-07) sans CSE — actions correctives, 2ᵉ décl. sans écart<br>[2031-250P-CAS08](#cas-08) avec CSE — actions correctives, 2ᵉ décl. sans écart + avis CSE sur les 2 décl.<br>[2031-250P-CAS09](#cas-09) sans CSE — 2ᵉ décl. avec écart → justification<br>[2031-250P-CAS10](#cas-10) avec CSE — 2ᵉ décl. avec écart → justification + avis CSE sur les 2 décl.<br>[2031-250P-CAS11](#cas-11) sans CSE — 2ᵉ décl. avec écart → éval. conjointe + rapport<br>[2031-250P-CAS12](#cas-12) avec CSE — 2ᵉ décl. avec écart → éval. conjointe + rapport + avis CSE sur les 2 décl. |
| **2032** | **7 indicateurs** | Les 12 cas :<br>[2032-250P-CAS01](#cas-01) sans CSE, aucun écart — fin de démarche<br>[2032-250P-CAS02](#cas-02) avec CSE, aucun écart — avis CSE « exactitude »<br>[2032-250P-CAS03](#cas-03) sans CSE — justification des écarts<br>[2032-250P-CAS04](#cas-04) avec CSE — justification + avis CSE<br>[2032-250P-CAS05](#cas-05) sans CSE — éval. conjointe + rapport<br>[2032-250P-CAS06](#cas-06) avec CSE — éval. conjointe + rapport + avis CSE<br>[2032-250P-CAS07](#cas-07) sans CSE — actions correctives, 2ᵉ décl. sans écart<br>[2032-250P-CAS08](#cas-08) avec CSE — actions correctives, 2ᵉ décl. sans écart + avis CSE sur les 2 décl.<br>[2032-250P-CAS09](#cas-09) sans CSE — 2ᵉ décl. avec écart → justification<br>[2032-250P-CAS10](#cas-10) avec CSE — 2ᵉ décl. avec écart → justification + avis CSE sur les 2 décl.<br>[2032-250P-CAS11](#cas-11) sans CSE — 2ᵉ décl. avec écart → éval. conjointe + rapport<br>[2032-250P-CAS12](#cas-12) avec CSE — 2ᵉ décl. avec écart → éval. conjointe + rapport + avis CSE sur les 2 décl. |
| **2033** | **7 indicateurs** | Les 12 cas :<br>[2033-250P-CAS01](#cas-01) sans CSE, aucun écart — fin de démarche<br>[2033-250P-CAS02](#cas-02) avec CSE, aucun écart — avis CSE « exactitude »<br>[2033-250P-CAS03](#cas-03) sans CSE — justification des écarts<br>[2033-250P-CAS04](#cas-04) avec CSE — justification + avis CSE<br>[2033-250P-CAS05](#cas-05) sans CSE — éval. conjointe + rapport<br>[2033-250P-CAS06](#cas-06) avec CSE — éval. conjointe + rapport + avis CSE<br>[2033-250P-CAS07](#cas-07) sans CSE — actions correctives, 2ᵉ décl. sans écart<br>[2033-250P-CAS08](#cas-08) avec CSE — actions correctives, 2ᵉ décl. sans écart + avis CSE sur les 2 décl.<br>[2033-250P-CAS09](#cas-09) sans CSE — 2ᵉ décl. avec écart → justification<br>[2033-250P-CAS10](#cas-10) avec CSE — 2ᵉ décl. avec écart → justification + avis CSE sur les 2 décl.<br>[2033-250P-CAS11](#cas-11) sans CSE — 2ᵉ décl. avec écart → éval. conjointe + rapport<br>[2033-250P-CAS12](#cas-12) avec CSE — 2ᵉ décl. avec écart → éval. conjointe + rapport + avis CSE sur les 2 décl. |
