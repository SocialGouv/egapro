...
| `ticket-spec-format.md` | ce qu'un spec de ticket doit porter, et où il vit selon le type d'issue | `architect` (écrit) · `code-dev`, `tu-dev`, `/analyse` (lisent). `bug-analyst` écrit un `## Analyse du bug`, dont le gabarit vit dans son propre AGENT.md |
