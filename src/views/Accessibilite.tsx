...
function Accessibilite({ history, location, dispatch }: Props) {
  return (
    <Page title="Accessibilité">
      <div css={styles.content}>
        ...
        <p>
          Le site Internet index-egapro.travail.gouv.fr n’est pas encore en
          conformité avec le référentiel général d’amélioration de
          l’accessibilité (RGAA). Le site n’a pas encore été audité.
        </p>
        <p>
          Nous tâchons de rendre dès la conception, ce site accessible à toutes
          et à tous.
        </p>
