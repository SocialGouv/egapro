  ...
  return (
    <Fragment>
      ...
      <FAQStep icon={<IconText>1</IconText>}>
        Calculer le nombre de femmes et d’hommes augmentés au cours de la période de référence.
      </FAQStep>
      ...
      <FAQStep icon={<IconText>3a</IconText>}>
        Un premier résultat est la valeur absolue de l'écart entre les deux taux calculés en 2. Cet écart est mesuré en
        "points de pourcentage". Exemple d'un taux d'augmentation des femmes de <em>33,13%</em> et d'un taux
        d'augmentation des hommes de <em>30,00%</em> d'où un écart de <em>3,13</em> points de pourcentage : la note sera
        calculée sur la donnée <em>3,13</em>.
      </FAQStep>

      <FAQStep icon={<IconText>3b</IconText>}>
        Un second résultat est "l'écart en nombre équivalent de salariés" : l'écart de taux calculé en 3a est appliqué
        au plus petit effectif entre les femmes et les hommes. Il correspond au plus petit nombre de salariés qu'il
        aurait fallu augmenter ou ne pas augmenter pour être à égalité des taux d'augmentation. Exemple d'un écart de{" "}
        <em>3,13</em> points de pourcentage dans une entreprise employant 15 femmes et 20 hommes : on applique{" "}
        <em>3,13%</em> à 15 femmes, pour un nombre équivalent de salariés de <em>0,4695</em>.
      </FAQStep>
      ...
      <FAQStep icon={<IconText>4</IconText>}>
        ...
        de la note finale, car étant la plus avantageuse. En reprenant l'exemple ci-dessus, c'est la donnée 3b arrondie
        (0,5) qui sera conservée, pour une note finale de 35 points.
      </FAQStep>
