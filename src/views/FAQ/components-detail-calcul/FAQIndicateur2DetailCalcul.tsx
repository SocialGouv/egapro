...
function FAQIndicateur2DetailCalcul() {
  return (
    <Fragment>
      ...
      <FAQStep icon={<IconText>2</IconText>}>
        Puis soustraire pour chaque groupe le pourcentage de femmes augmentées à
        celui des hommes augmenté.
      </FAQStep>
      ...
      <FAQStep icon={<IconText>4</IconText>}>
        ...
        l’ecart global de taux de d'augmentation entre les hommes et les femmes.
        <br />
      ...
      <div css={styles.content}>
        ...
        <FAQStep icon={<IconLamp />}>
          ...
          (indicateur 1), la note maximale de 20 points est attribuée à
