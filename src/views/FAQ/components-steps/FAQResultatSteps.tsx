  ...
  return (
    <Fragment>
      <FAQStep icon={<IconLamp />}>
        ...
        . Toutes les informations nécessaires à la transmission se trouvent sur
        ce récapitulatif.
      </FAQStep>
      <FAQStep icon={<IconLamp />}>
        L'index doit être publié sur le site internet de l'entreprise déclarante
        ou en l'absence de site internet, communiqué aux salariés. Les résultats
        doivent par ailleurs être communiqués au CSE.
      </FAQStep>
      <FAQStep icon={<IconLamp />}>
        <p css={styles.para}>
          Si l’entreprise obtient moins de 75 points, elle devra mettre en
          oeuvre des mesures de correction lui permettant d’atteindre au moins
          75 points dans un délai 3 ans.
        </p>
        ...
        <ul css={styles.list}>
          ...
          <li>
            ...
            être intégrée au plan d’action devant être établi à défaut d’accord
