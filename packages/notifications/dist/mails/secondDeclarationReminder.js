...
export const buildSecondDeclarationReminderMail = (payload) => {
...
${calloutWarning("En l'absence de transmission avant la date limite, votre entreprise s'expose aux mesures prévues par la réglementation.")}
${ctaButton({
...
`;
    return {
        ...
        html: wrapEmail({
            title: subject,
            intro: "Votre seconde déclaration n'a pas encore été transmise pour cette campagne.",
            body,
        }),
    };
};
