...
export const buildAnnualDeadlineReminderMail = (payload) => {
...
${calloutWarning("La date limite de transmission approche. Pensez à finaliser votre déclaration pour éviter toute pénalité.")}
${ctaButton({
