...
export const buildSecondDeclarationSubmittedMail: MailBuilder<
...
${calloutWarning(
	"Vous restez tenus aux obligations complémentaires liées à l'écart constaté (mesures de correction, suivi annuel).",
)}
${ctaButton({
...
`;
	return {
		...
		html: wrapEmail({
			title: subject,
			intro:
				"Votre seconde déclaration a bien été enregistrée sur la plateforme.",
			body,
		}),
	};
};
