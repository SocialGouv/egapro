  ...
  return (
    <Fragment>
      ...
      <FAQStep icon={<IconGrow valid={false} />}>
        ...
        exclut les augmentations de salaires liées à une promotion.
      </FAQStep>
      ...
      <FAQStep icon={<IconLamp />}>
        Si aucune augmentation individuelle n'est intervenue au cours de la
        période de référence, l’indicateur n’est pas calculable.
      </FAQStep>
