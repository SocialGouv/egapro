export const NAF = {
  ...
  "01.61Z": {
    ...
    groupe: {
      code: "01.6",
      description: "Activit\u00e9s de soutien \u00e0 l'agriculture et traitement primaire des r\u00e9coltes",
    },
    division: {
      code: "01",
      description: "Culture et production animale, chasse et services annexes",
  ...
  "10.11Z": {
    ...
    groupe: {
      code: "10.1",
      description: "Transformation et conservation de la viande et pr\u00e9paration de produits \u00e0 base de viande",
    },
    division: {
      code: "10",
  ...
  "10.71A": {
    ...
    groupe: {
      code: "10.7",
      description: "Fabrication de produits de boulangerie-p\u00e2tisserie et de p\u00e2tes alimentaires",
    },
    division: {
      code: "10",
      description: "Industries alimentaires",
  ...
  "17.21A": {
    ...
    classe: {
      code: "17.21",
      description: "Fabrication de papier et carton ondul\u00e9s et d'emballages en papier ou en carton",
    },
    groupe: {
      code: "17.2",
  ...
  "20.13B": {
    code: "20.13B",
    description: "Fabrication d'autres produits chimiques inorganiques de base n.c.a.",
    classe: {
      code: "20.13",
      description: "Fabrication d'autres produits chimiques inorganiques de base",
    },
  ...
  "23.91Z": {
    ...
    groupe: {
      code: "23.9",
      description: "Fabrication de produits abrasifs et de produits min\u00e9raux non m\u00e9talliques n.c.a.",
    },
    division: {
      code: "23",
      description: "Fabrication d'autres produits min\u00e9raux non m\u00e9talliques",
  ...
  "23.99Z": {
    code: "23.99Z",
    description: "Fabrication d'autres produits min\u00e9raux non m\u00e9talliques n.c.a.",
    classe: {
      code: "23.99",
      description: "Fabrication d'autres produits min\u00e9raux non m\u00e9talliques n.c.a.",
    },
  ...
  "24.31Z": {
    ...
    groupe: {
      code: "24.3",
      description: "Fabrication d'autres produits de premi\u00e8re transformation de l'acier",
    },
    division: {
      code: "24",
      description: "M\u00e9tallurgie",
  ...
  "25.21Z": {
    ...
    groupe: {
      code: "25.2",
      description: "Fabrication de r\u00e9servoirs, citernes et conteneurs m\u00e9talliques",
    },
    division: {
      code: "25",
      description:
  ...
  "26.11Z": {
    ...
    division: {
      code: "26",
      description: "Fabrication de produits informatiques, \u00e9lectroniques et optiques",
    },
    section: {
      code: "C",
      description: "INDUSTRIE MANUFACTURI\u00c8RE",
  ...
  "26.51A": {
    ...
    classe: {
      code: "26.51",
      description: "Fabrication d'instruments et d'appareils de mesure, d'essai et de navigation",
    },
    groupe: {
      code: "26.5",
      description: "Fabrication d'instruments et d'appareils de mesure, d'essai et de navigation ; horlogerie",
    },
    division: {
      code: "26",
      description: "Fabrication de produits informatiques, \u00e9lectroniques et optiques",
  ...
  "27.31Z": {
    ...
    groupe: {
      code: "27.3",
      description: "Fabrication de fils et c\u00e2bles et de mat\u00e9riel d'installation \u00e9lectrique",
    },
    division: {
      code: "27",
      description: "Fabrication d'\u00e9quipements \u00e9lectriques",
  ...
  "28.41Z": {
    ...
    groupe: {
      code: "28.4",
      description: "Fabrication de machines de formage des m\u00e9taux et de machines-outils",
    },
    division: {
      code: "28",
      description: "Fabrication de machines et \u00e9quipements n.c.a.",
  ...
  "32.11Z": {
    ...
    groupe: {
      code: "32.1",
      description: "Fabrication d\u2019articles de joaillerie, bijouterie et articles similaires",
    },
    division: {
      code: "32",
  ...
  "32.50A": {
    ...
    classe: {
      code: "32.50",
      description: "Fabrication d'instruments et de fournitures \u00e0 usage m\u00e9dical et dentaire ",
    },
    groupe: {
      code: "32.5",
      description: "Fabrication d'instruments et de fournitures \u00e0 usage m\u00e9dical et dentaire",
  ...
  "33.11Z": {
    ...
    groupe: {
      code: "33.1",
      description: "R\u00e9paration d'ouvrages en m\u00e9taux, de machines et d'\u00e9quipements",
    },
    division: {
      code: "33",
  ...
  "38.11Z": {
    ...
    division: {
      code: "38",
      description: "Collecte, traitement et \u00e9limination des d\u00e9chets ; r\u00e9cup\u00e9ration",
    },
    section: {
      code: "E",
      description: "PRODUCTION ET DISTRIBUTION D'EAU ; ASSAINISSEMENT, GESTION DES D\u00c9CHETS ET D\u00c9POLLUTION",
  ...
  "43.21A": {
    ...
    groupe: {
      code: "43.2",
      description: "Travaux d'installation \u00e9lectrique, plomberie et autres travaux d'installation",
    },
    division: {
      code: "43",
      description: "Travaux de construction sp\u00e9cialis\u00e9s ",
  ...
  "43.22A": {
    ...
    classe: {
      code: "43.22",
      description: "Travaux de plomberie et installation de chauffage et de conditionnement d'air",
    },
    groupe: {
      code: "43.2",
      description: "Travaux d'installation \u00e9lectrique, plomberie et autres travaux d'installation",
  ...
  "46.12A": {
    ...
    classe: {
      code: "46.12",
      description: "Interm\u00e9diaires du commerce en combustibles, m\u00e9taux, min\u00e9raux et produits chimiques",
    },
    groupe: {
      code: "46.1",
      description: "Interm\u00e9diaires du commerce de gros",
  ...
  "46.21Z": {
    ...
    groupe: {
      code: "46.2",
      description: "Commerce de gros de produits agricoles bruts et d'animaux vivants",
    },
    division: {
      code: "46",
      description: "Commerce de gros, \u00e0 l\u2019exception des automobiles et des motocycles",
  ...
  "46.31Z": {
    ...
    groupe: {
      code: "46.3",
      description: "Commerce de gros de produits alimentaires, de boissons et de tabac",
    },
    division: {
      code: "46",
      description: "Commerce de gros, \u00e0 l\u2019exception des automobiles et des motocycles",
  ...
  "46.33Z": {
    ...
    classe: {
      code: "46.33",
      description: "Commerce de gros de produits laitiers, \u0153ufs, huiles et mati\u00e8res grasses comestibles",
    },
    groupe: {
      code: "46.3",
      description: "Commerce de gros de produits alimentaires, de boissons et de tabac",
  ...
  "46.38A": {
    ...
    classe: {
      code: "46.38",
      description: "Commerce de gros d'autres produits alimentaires, y compris poissons, crustac\u00e9s et mollusques",
    },
    groupe: {
      code: "46.3",
      description: "Commerce de gros de produits alimentaires, de boissons et de tabac",
  ...
  "46.39A": {
    ...
    classe: {
      code: "46.39",
      description: "Commerce de gros non sp\u00e9cialis\u00e9 de denr\u00e9es, boissons et tabac",
    },
    groupe: {
      code: "46.3",
      description: "Commerce de gros de produits alimentaires, de boissons et de tabac",
  ...
  "46.44Z": {
    ...
    classe: {
      code: "46.44",
      description: "Commerce de gros de vaisselle, verrerie et produits d'entretien",
    },
    groupe: {
      code: "46.4",
      description: "Commerce de gros de biens domestiques",
  ...
  "46.47Z": {
    ...
    classe: {
      code: "46.47",
      description: "Commerce de gros de meubles, de tapis et d'appareils d'\u00e9clairage ",
    },
    groupe: {
      code: "46.4",
      description: "Commerce de gros de biens domestiques",
  ...
  "46.51Z": {
    ...
    groupe: {
      code: "46.5",
      description: "Commerce de gros d'\u00e9quipements de l'information et de la communication ",
    },
    division: {
      code: "46",
      description: "Commerce de gros, \u00e0 l\u2019exception des automobiles et des motocycles",
  ...
  "46.63Z": {
    ...
    classe: {
      code: "46.63",
      description: "Commerce de gros de machines pour l'extraction, la construction et le g\u00e9nie civil ",
    },
    groupe: {
      code: "46.6",
      description: "Commerce de gros d'autres \u00e9quipements industriels",
  ...
  "46.64Z": {
    ...
    classe: {
      code: "46.64",
      description: "Commerce de gros de machines pour l'industrie textile et l'habillement",
    },
    groupe: {
      code: "46.6",
      description: "Commerce de gros d'autres \u00e9quipements industriels",
  ...
  "46.73A": {
    ...
    classe: {
      code: "46.73",
      description: "Commerce de gros de bois, de mat\u00e9riaux de construction et d'appareils sanitaires ",
    },
    groupe: {
      code: "46.7",
      description: "Autres commerces de gros sp\u00e9cialis\u00e9s",
  ...
  "46.74A": {
    ...
    classe: {
      code: "46.74",
      description: "Commerce de gros de quincaillerie et fournitures pour plomberie et chauffage",
    },
    groupe: {
      code: "46.7",
      description: "Autres commerces de gros sp\u00e9cialis\u00e9s",
  ...
  "47.43Z": {
    ...
    classe: {
      code: "47.43",
      description: "Commerce de d\u00e9tail de mat\u00e9riels audio/vid\u00e9o en magasin sp\u00e9cialis\u00e9",
    },
    groupe: {
      code: "47.4",
      description:
  ...
  "47.51Z": {
    ...
    groupe: {
      code: "47.5",
      description: "Commerce de d\u00e9tail d'autres \u00e9quipements du foyer en magasin sp\u00e9cialis\u00e9",
    },
    division: {
      code: "47",
      description: "Commerce de d\u00e9tail, \u00e0 l\u2019exception des automobiles et des motocycles",
  ...
  "47.52A": {
    ...
    classe: {
      code: "47.52",
      description: "Commerce de d\u00e9tail de quincaillerie, peintures et verres en magasin sp\u00e9cialis\u00e9",
    },
    groupe: {
      code: "47.5",
      description: "Commerce de d\u00e9tail d'autres \u00e9quipements du foyer en magasin sp\u00e9cialis\u00e9",
  ...
  "47.52B": {
    code: "47.52B",
    description: "Commerce de d\u00e9tail de quincaillerie, peintures et verres en grandes surfaces (400 m2et plus)",
    classe: {
      code: "47.52",
      description: "Commerce de d\u00e9tail de quincaillerie, peintures et verres en magasin sp\u00e9cialis\u00e9",
    },
  ...
  "47.61Z": {
    ...
    groupe: {
      code: "47.6",
      description: "Commerce de d\u00e9tail de biens culturels et de loisirs en magasin sp\u00e9cialis\u00e9",
    },
    division: {
      code: "47",
      description: "Commerce de d\u00e9tail, \u00e0 l\u2019exception des automobiles et des motocycles",
  ...
  "47.72A": {
    ...
    classe: {
      code: "47.72",
      description: "Commerce de d\u00e9tail de chaussures et d'articles en cuir en magasin sp\u00e9cialis\u00e9",
    },
    groupe: {
      code: "47.7",
      description: "Autres commerces de d\u00e9tail en magasin sp\u00e9cialis\u00e9",
  ...
  "47.78A": {
    ...
    classe: {
      code: "47.78",
      description: "Autre commerce de d\u00e9tail de biens neufs en magasin sp\u00e9cialis\u00e9",
    },
    groupe: {
      code: "47.7",
      description: "Autres commerces de d\u00e9tail en magasin sp\u00e9cialis\u00e9",
  ...
  "47.99A": {
    ...
    classe: {
      code: "47.99",
      description: "Autres commerces de d\u00e9tail hors magasin, \u00e9ventaires ou march\u00e9s",
    },
    groupe: {
      code: "47.9",
      description: "Commerce de d\u00e9tail hors magasin, \u00e9ventaires ou march\u00e9s",
  ...
  "58.11Z": {
    ...
    groupe: {
      code: "58.1",
      description: "\u00c9dition de livres et p\u00e9riodiques et autres activit\u00e9s d'\u00e9dition ",
    },
    division: {
      code: "58",
      description: "\u00c9dition",
  ...
  "63.11Z": {
    ...
    groupe: {
      code: "63.1",
      description: "Traitement de donn\u00e9es, h\u00e9bergement et activit\u00e9s connexes ; portails Internet",
    },
    division: {
      code: "63",
  ...
  "64.91Z": {
    ...
    groupe: {
      code: "64.9",
      description: "Autres activit\u00e9s des services financiers, hors assurance et caisses de retraite",
    },
    division: {
      code: "64",
      description: "Activit\u00e9s des services financiers, hors assurance et caisses de retraite",
  ...
  "64.99Z": {
    code: "64.99Z",
    description: "Autres activit\u00e9s des services financiers, hors assurance et caisses de retraite, n.c.a.",
    classe: {
      code: "64.99",
      description: "Autres activit\u00e9s des services financiers, hors assurance et caisses de retraite, n.c.a.",
    },
  ...
  "66.11Z": {
    ...
    groupe: {
      code: "66.1",
      description: "Activit\u00e9s auxiliaires de services financiers, hors assurance et caisses de retraite",
    },
    division: {
      code: "66",
  ...
  "66.19A": {
    ...
    classe: {
      code: "66.19",
      description: "Autres activit\u00e9s auxiliaires de services financiers, hors assurance et caisses de retraite",
    },
    groupe: {
      code: "66.1",
      description: "Activit\u00e9s auxiliaires de services financiers, hors assurance et caisses de retraite",
  ...
  "68.20A": {
    ...
    classe: {
      code: "68.20",
      description: "Location et exploitation de biens immobiliers propres ou lou\u00e9s ",
    },
    groupe: {
      code: "68.2",
      description: "Location et exploitation de biens immobiliers propres ou lou\u00e9s",
  ...
  "74.90A": {
    ...
    classe: {
      code: "74.90",
      description: "Autres activit\u00e9s sp\u00e9cialis\u00e9es, scientifiques et techniques n.c.a.",
    },
    groupe: {
      code: "74.9",
      description: "Autres activit\u00e9s sp\u00e9cialis\u00e9es, scientifiques et techniques n.c.a.",
  ...
  "77.11A": {
    ...
    classe: {
      code: "77.11",
      description: "Location et location-bail de voitures et de v\u00e9hicules automobiles l\u00e9gers",
    },
    groupe: {
      code: "77.1",
  ...
  "77.31Z": {
    ...
    groupe: {
      code: "77.3",
      description: "Location et location-bail d'autres machines, \u00e9quipements et biens",
    },
    division: {
      code: "77",
      description: "Activit\u00e9s de location et location-bail",
  ...
  "77.39Z": {
    code: "77.39Z",
    description: "Location et location-bail d'autres machines, \u00e9quipements et biens mat\u00e9riels n.c.a. ",
    classe: {
      code: "77.39",
      description: "Location et location-bail d'autres machines, \u00e9quipements et biens mat\u00e9riels n.c.a. ",
    },
  ...
  "82.11Z": {
    ...
    division: {
      code: "82",
      description: "Activit\u00e9s administratives et autres activit\u00e9s de soutien aux entreprises",
    },
    section: {
      code: "N",
      description: "ACTIVIT\u00c9S DE SERVICES ADMINISTRATIFS ET DE SOUTIEN",
  ...
  "87.20A": {
    ...
    classe: {
      code: "87.20",
      description: "H\u00e9bergement social pour personnes handicap\u00e9es mentales, malades mentales et toxicomanes",
    },
    groupe: {
      code: "87.2",
      description: "H\u00e9bergement social pour personnes handicap\u00e9es mentales, malades mentales et toxicomanes",
  ...
  "87.30A": {
    ...
    classe: {
      code: "87.30",
      description: "H\u00e9bergement social pour personnes \u00e2g\u00e9es ou handicap\u00e9es physiques ",
    },
    groupe: {
      code: "87.3",
      description: "H\u00e9bergement social pour personnes \u00e2g\u00e9es ou handicap\u00e9es physiques ",
  ...
  "88.99A": {
    code: "88.99A",
    description: "Autre accueil ou accompagnement sans h\u00e9bergement d\u2019enfants\n et d\u2019adolescents\n",
    classe: {
      code: "88.99",
  ...
  "91.01Z": {
    ...
    groupe: {
      code: "91.0",
      description: "Biblioth\u00e8ques, archives, mus\u00e9es et autres activit\u00e9s culturelles",
    },
    division: {
      code: "91",
      description: "Biblioth\u00e8ques, archives, mus\u00e9es et autres activit\u00e9s culturelles",
  ...
  "94.11Z": {
    ...
    groupe: {
      code: "94.1",
      description: "Activit\u00e9s des organisations \u00e9conomiques, patronales et professionnelles",
    },
    division: {
      code: "94",
  ...
  "95.11Z": {
    ...
    division: {
      code: "95",
      description: "R\u00e9paration d'ordinateurs et de biens personnels et domestiques",
    },
    section: {
      code: "S",
      description: "AUTRES ACTIVIT\u00c9S DE SERVICES",
...
export type NAF = typeof NAF;

type CodeDescKeys = {
  [K in keyof NAF[keyof NAF]]: NAF[keyof NAF][K] extends { code: string; description: string } ? K : never;
}[keyof NAF[keyof NAF]];
type NafExporter<T extends CodeDescKeys> = {
  [K in keyof NAF as NAF[K][T]["code"]]: NAF[K][T]["description"];
};
...
export const NAF_CLASSES = nafExporter("classe");
export const NAF_DIVISIONS = nafExporter("division");
export const NAF_GROUPES = nafExporter("groupe");
