...
export interface Repo<T extends Entity<Any, Any>, ID = NonNullable<T["id"]>>
    extends SimpleRepo {
...
export interface BulkRepo<T extends Entity<Any, Any>, ID = NonNullable<T["id"]>>
    extends Repo<T, ID> {
