 ...
 */
export type Remunerations = WithPopulationFavorable & {
 ...
 */
export type Augmentations = WithPopulationFavorable & {
  /**
 ...
 * @maxItems 4
 */
export type CategoriesSimples = [number | null, number | null, number | null, number | null];
/**
 ...
 */
export type AugmentationsEtPromotions = WithPopulationFavorable & {
  /**
   * Trois items : Effectif des groupes valides inférieur à 40% de l'effectif total (egvi40pcet) ou Absence d'augmentations individuelles (absaugi)
   */
 ...
 */
export type HautesRemunerations = WithPopulationFavorable & {
  /**
   * Nombre de 0 à 5 du sexe sous représenté parmi les 10 plus hautes rémunérations
   */
  résultat?: number;
};
...
export interface DeclarationDTO {
  ...
  déclaration: {
     ...
     */
    mesures_correctives?: "mmo" | "me" | "mne";
    /**
