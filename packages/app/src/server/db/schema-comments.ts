...
export const SCHEMA_COLUMN_COMMENTS: SchemaColumnComments = {
	declaration: {
		...
		// Indicator F — annual quartile thresholds (GIP-MDS origin)
		...
		// Indicator F — annual quartile women proportions (GIP-MDS origin)
		...
		// Indicator F — annual quartile men proportions (GIP-MDS origin)
		...
		// Indicator F — hourly quartile thresholds (GIP-MDS origin)
		...
		// Indicator F — hourly quartile women proportions (GIP-MDS origin)
		...
		// Indicator F — hourly quartile men proportions (GIP-MDS origin)
