...
export const SCHEMA_COLUMN_COMMENTS: SchemaColumnComments = {
	declaration: {
		// Indicator A — mean global remuneration (GIP-MDS origin)
		...
		// Indicator B — mean variable remuneration (GIP-MDS origin)
		...
		// Indicator C — median global remuneration (GIP-MDS origin)
		...
		// Indicator D — median variable remuneration (GIP-MDS origin)
		...
		// Indicator E — variable pay beneficiary counts (GIP-MDS origin)
		...
		// Indicator F — quartile thresholds, annual (GIP-MDS origin)
		...
		// Indicator F — quartile women proportions, annual (GIP-MDS origin)
		...
		// Indicator F — quartile men proportions, annual (GIP-MDS origin)
		...
		// Indicator F — quartile thresholds, hourly (GIP-MDS origin)
		...
		// Indicator F — quartile women proportions, hourly (GIP-MDS origin)
		...
		// Indicator F — quartile men proportions, hourly (GIP-MDS origin)
