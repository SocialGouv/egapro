...
describe("fetchCompanyBySiren", () => {
	...
	it("does not call a half-declared foreign establishment French", async () => {
		fetchSpy.mockResolvedValueOnce({
			ok: true,
			json: async () => ({
				content: [
					{
						siren: "532847196",
						denominationunitelegale: "Half Declared",
						raisonsociale: null,
						activiteprincipaleunitelegale: "6201Z",
						activiteprincipalenaf25unitelegale: "6202A",
						nomenclatureactiviteprincipaleunitelegale: "NAFRev2",
				...
				content: [
					{
						...
						raisonsociale: null,
						activiteprincipaleunitelegale: "8411A",
				...
				content: [
					{
						...
						raisonsociale: null,
						activiteprincipaleunitelegale: "4759B",
				...
				content: [
					{
						...
						activiteprincipaleunitelegale: "7022A",
				...
				content: [
					{
						...
						raisonsociale: null,
						activiteprincipaleunitelegale: "4321B",
