    ...
    <Container py="8w">
      <Grid align="center">
        <GridCol md={10} lg={8}>
          ...
          <h2>Objet</h2>
          <p>
            EgaPro entend faire progresser au sein des entreprises l'égalité salariale entre les femmes et les hommes.
            Il permet aux entreprises de mesurer, en toute transparence, les écarts de rémunération entre les sexes et
          ...
          <p>
            Le code du logiciel est libre, et peut donc être vérifié et amélioré par tous :<br />
