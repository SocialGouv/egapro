    ...
    <Container py="8w">
      <Grid align="center">
        <GridCol md={10} lg={8}>
          ...
          <p>
            Egapro utilise le service d’identification ProConnect pour garantir l’appartenance de l’Utilisateur à
            l’entreprise déclarante. L’Utilisateur doit créer un compte ProConnect, en renseignant notamment son adresse
            email, et s’identifier avec ce compte pour déclarer sur Egapro.
          </p>
          <h3 className="fr-text--xl">
