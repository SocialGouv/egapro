...
const title = "Conditions d'utilisation de EgaPro";
const description =
    ...
    <Container py="8w">
      <Grid align="center">
        <GridCol md={10} lg={8}>
          ...
          <h3 className="fr-text--xl">1 – Index EgaPro sur l'égalité professionnelle</h3>
          <p>
          ...
          <h3 className="fr-text--xl">
            2 – Index EgaPro sur la répartition équilibrée entre hommes et femmes au sein des postes dirigeants des
            grandes entreprises
          </h3>
          <p>
            EgaPro a mis en place une déclaration sur la répartition équilibrée afin qu'elle soit transmise au Ministère
            du Travail. Tout utilisateur, sans se créer de compte, peut remplir des informations le concernant, des
            informations concernant son entreprise en prenant en compte la période de référence, les écarts de
            représentation. Le déclarant renseigne son nom, prénom, son adresse e-mail, son numéro de téléphone mais
            également le numéro SIREN de son entreprise afin de réaliser sa déclaration concernant la répartition
            équilibrée.
          </p>
          <p>
