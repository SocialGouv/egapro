...
export const NOT_BELOW_N = (n: number) => `Le résultat ne peut pas être inférieur à ${n}`;
export const NOT_BELOW_0 = NOT_BELOW_N(0);
export const MANDATORY_FAVORABLE_POPULATION = "La population envers laquelle l'écart est favorable est obligatoire";
export const NOT_HIGHER_THAN_N = (n: number) => `Le résultat ne peut pas être supérieur à ${n}`;
export const NOT_ALL_EMPTY_CATEGORIES = "Au moins une catégorie doit avoir un écart renseigné";
export const MANDATORY_SIREN_ERROR = "Le Siren est requis";
export const INVALID_SIREN_ERROR = "Le Siren est composé de 9 chiffres sans espace";
