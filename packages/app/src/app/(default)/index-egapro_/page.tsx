      ...
      <Container>
        <Grid>
          <GridCol lg={7}>
            ...
            <p>
              Les entreprises ayant obtenu un index inférieur à 75 points doivent publier, par une communication externe
              et au sein de l’entreprise, les mesures de correction qu’elles ont définies par accord ou, à défaut, par
              décision unilatérale. Par ailleurs, celles ayant obtenu un index inférieur à 85 points doivent fixer,
              également par accord ou, à défaut, par décision unilatérale, et publier des objectifs de progression de
              chacun des indicateurs de l’Index.
            </p>
          </GridCol>
          <GridCol lg={5}>
            <ImgRepresentationEquilibree />
        ...
        <Card
          ...
          desc={
            <>
              ...
              sur le site internet de l’entreprise lorsqu’il en existe un, sur la même page que les résultats obtenus à
              l’Index, dès lors que l’accord ou la décision unilatérale est déposé.
              <br />
              <br />
              Les mesures de correction doivent rester consultables jusqu’à ce que l’entreprise obtienne un index au
              moins égal à 75 points. L'entreprise doit par ailleurs les porter à la connaissance des salariés par tout
              moyen.
              <br />
              <br />
              Les objectifs de progression doivent rester consultables jusqu’à ce que l’entreprise obtienne un index au
              moins égal à 85 points. À défaut de site internet, ils doivent être portés à la connaissance des salariés
              par tout moyen.
            </>
          }
        />
