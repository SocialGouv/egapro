...
export const env = createEnv({
	...
	server: {
		...
		// Campaign deadlines (ISO date format YYYY-MM-DD)
		EGAPRO_DECL1_MODIFICATION_DEADLINE: z.iso.date(),
		EGAPRO_DECL1_JUSTIFICATION_DEADLINE: z.iso.date(),
		EGAPRO_DECL1_JOINT_EVALUATION_DEADLINE: z.iso.date(),
		EGAPRO_DECL2_MODIFICATION_DEADLINE: z.iso.date(),
		EGAPRO_DECL2_JUSTIFICATION_DEADLINE: z.iso.date(),
		EGAPRO_DECL2_JOINT_EVALUATION_DEADLINE: z.iso.date(),
	},
	...
	runtimeEnv: {
		...
		EGAPRO_DECL1_MODIFICATION_DEADLINE:
			process.env.EGAPRO_DECL1_MODIFICATION_DEADLINE,
		EGAPRO_DECL1_JUSTIFICATION_DEADLINE:
			process.env.EGAPRO_DECL1_JUSTIFICATION_DEADLINE,
		EGAPRO_DECL1_JOINT_EVALUATION_DEADLINE:
			process.env.EGAPRO_DECL1_JOINT_EVALUATION_DEADLINE,
		EGAPRO_DECL2_MODIFICATION_DEADLINE:
			process.env.EGAPRO_DECL2_MODIFICATION_DEADLINE,
		EGAPRO_DECL2_JUSTIFICATION_DEADLINE:
			process.env.EGAPRO_DECL2_JUSTIFICATION_DEADLINE,
		EGAPRO_DECL2_JOINT_EVALUATION_DEADLINE:
			process.env.EGAPRO_DECL2_JOINT_EVALUATION_DEADLINE,
