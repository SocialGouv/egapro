...
export default function EcartRep() {
  return (
    <section>
                  ...
                  <div className="fr-card__content">
                    ...
                    <div className="fr-card__desc">
                      <div>
                        ...
                        d’autre part, les membres de leurs instances dirigeantes, en parallèle de la publication et de
...
EcartRep.getLayout = function getLayout(page: React.ReactElement) {
