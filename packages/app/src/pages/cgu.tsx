        ...
        <Grid justifyCenter>
          <GridCol md={10} lg={8}>
            ...
            <p>
              ...
              entreprises de mesurer, en toute transparence, les écarts de représentation dans les services dirigeants
              et de mettre en évidence leurs points de progression.
            </p>
            ...
            <p>
              ...
              remplir des informations concernant son entreprise afin de calculer son Index et de connaître les écarts
              de salaire entre hommes et femmes au sein de sa structure. Dans le cadre du remplissage de ce formulaire,
              l’utilisateur a la possibilité de renseigner son adresse email afin d’enregistrer les données fournies et
              de remplir sa déclaration plus tard.
            </p>
            <p>
            ...
            <p>
              ...
              tiers extérieurs. Ces tiers sont les seuls responsables du contenu publié par leur soin. L’équipe n’a
              aucun contrôle sur le contenu de ces sites, ces contenus ne sauraient engager la responsabilité de
              l’administration.
            </p>
