          ...
          <Grid justifyCenter>
            <GridCol md={10} lg={8}>
              ...
              <p>
                ...
                Plateforme EgaPro et définissent les conditions d’accès et d’utilisation des services par l’Utilisateur.
              </p>
              ...
              <h2>Objet</h2>
              <p>
                EgaPro met en place deux index conçus pour lutter contre l’inégalité entre les femmes et les hommes.
              </p>
              <p>
              ...
              <p>
                ...
                professionnelle et la représentation équilibrée femmes-hommes dans les services dirigeants. Il permet
                aux entreprises de mesurer, en toute transparence, les écarts de représentation dans les services
                dirigeants et de mettre en évidence leurs points de progression.
              </p>
              <h2>Fonctionnalités</h2>
              <h3 className="fr-text--xl">Index EgaPro sur l’égalité professionnelle</h3>
              <p>
                EgaPro a mis en place un simulateur en ligne grâce auquel tout utilisateur, sans se créer de compte,
                peut remplir des informations concernant son entreprise afin de calculer son Index et de connaître les
                écarts de salaire entre hommes et femmes au sein de sa structure. Dans le cadre du remplissage de ce
                formulaire, l’utilisateur a la possibilité de renseigner son adresse email afin d’enregistrer les
                données fournies et de remplir sa déclaration plus tard.
              </p>
              <p>
                EgaPro propose également un formulaire de déclaration de cet Index afin qu’il soit transmis au Ministère
                du Travail.
              </p>
              ...
              <p>
                Les sources des informations diffusées sur la Plateforme sont réputées fiables mais le site ne garantit
                pas qu’il soit exempt de défauts, d’erreurs ou d’omissions.
              </p>
              <p>
                Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement de la Plateforme
                et sous réserve de toute interruption ou modification en cas de maintenance, n'engage pas la
                responsabilité de EgaPro.
              </p>
              <p>
              ...
              <p>
                Ce site peut mettre à disposition des liens pouvant orienter l’utilisateur vers des sites réalisés par
                des tiers extérieurs. Ces tiers sont les seuls responsables du contenu publié par leur soin. L’équipe
                n’a aucun contrôle sur le contenu de ces sites, ces contenus ne sauraient engager la responsabilité de
                l’administration.
              </p>
