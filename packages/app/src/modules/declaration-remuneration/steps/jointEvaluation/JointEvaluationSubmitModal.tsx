...
const MODAL_ID = "joint-evaluation-submit-modal";
						...
						<div className="fr-modal__body">
							...
							<div className="fr-modal__content">
								...
								<p>
									...
									Travail le rapport de l&apos;évaluation conjointe des
									rémunérations.
								</p>
								<div className="fr-checkbox-group fr-mt-2w">
									<input
										checked={certified}
										id="joint-evaluation-certify"
										onChange={(e) => setCertified(e.target.checked)}
										type="checkbox"
									/>
									<label
										className="fr-label"
										htmlFor="joint-evaluation-certify"
									>
										Je certifie que le rapport transmis est conforme.
									</label>
								</div>
							</div>
