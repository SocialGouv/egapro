...
async def test_stats_endpoint(client):
    await db.declaration.put(
        "12345671",
        constants.PUBLIC_YEARS[-1],
        "foo@bar.org",
        {
            "déclaration": {"index": 95, "année_indicateurs": constants.PUBLIC_YEARS[-1]},
            "id": "12345678-1234-5678-9012-123456789013",
            "entreprise": {
                "raison_sociale": "Bio c Bon",
                "effectif": {"tranche": "1000:"},
    ...
    await db.declaration.put(
        ...
        "foo@bar.org",
        {
            "déclaration": {"index": 93, "année_indicateurs": constants.PUBLIC_YEARS[-1]},
