...
const kintoCollection: KintoCollection<IndicatorsData> = collection<IndicatorsData>('indicators_datas');

const add: (record: IndicatorsData) => Promise<IndicatorsData> = async (record: IndicatorsData) => {
...
const update: (record: IndicatorsData) => Promise<IndicatorsData> = async (record: IndicatorsData) => {
    if (!record.id) {
